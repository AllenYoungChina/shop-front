  ...
  <div class="floors">
    <div class="sk">
      <div class="sk_inner w1200">
        <div class="sk_hd">
          <a href="javascript:;">
            <img src="img/s_img1.png" alt="">
          </a>
        </div>
        <div class="sk_bd">
          <div class="layui-carousel" id="test1">
            <div class="carousel-item">
              <div class="item-box" v-for="(commodityInfo, k) in commodityInfo" :key="k">
                <div class="item" v-for="(c, key) in commodityInfo" :key="key">
                  <router-link to="`/commodity/detail/${c.id}`">
                    <img :src="path + c.img" alt="">
                  </router-link>
  ...
  <div class="product-cont w1200" id="product-cont">
    <div class="product-item product-item1 layui-clear">
      ...
      <div class="right-cont">
        ...
        <div class="img-box">
          <router-link v-for="(c, key) in clothes" :key="key"
                       to="`/commodity/detail/${c.id}`">
            <img :src="path + c.img" alt="">
          </router-link>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      food: [],
      goods: [],
      path: this.$store.state.lookImgUrl  // 获取状态管理的lookImgUrl
    }
  },
  mounted: function () {
